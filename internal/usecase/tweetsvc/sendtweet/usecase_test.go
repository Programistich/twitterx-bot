...
func TestUseCaseSendTweetSelectsPhoto(t *testing.T) {
	fetcher := &fakeFetcher{
		tweet: &twitterxapi.Tweet{
			ID:   "321",
			Text: "photo",
...
func TestUseCaseSendTweetSelectsMediaGroup(t *testing.T) {
...
func TestUseCaseSendTweetSelectsText(t *testing.T) {
	fetcher := &fakeFetcher{
		tweet: &twitterxapi.Tweet{
			ID:   "777",
			Text: "just text",
...
func TestUseCaseSendTweetFetcherError(t *testing.T) {
...
func TestUseCaseSendTweetSenderError(t *testing.T) {
